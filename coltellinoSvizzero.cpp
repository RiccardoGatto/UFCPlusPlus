...
int main()
{
    ...
    cout << piuGrande(2, 6);
    cout << "\n\n";
    cout << (isEven(4) ? "E' pari" : "E' dispari");
    cout << "\n\n";
    cout << (isEven(5) ? "E' pari" : "E' dispari");
    cout << "\n\n";
    ...
    stampaNome("Riccardo");
    cout << "\n\n";
    cout << (isBetween(4, 5, 6) ? "E' compreso" : "Non e' compreso");
    cout << "\n\n";
    cout << (isBetween(4, 6, 5) ? "E' compreso" : "Non e' compreso");
    cout << "\n\n";
    equazione(4, 5, 6);
    cout << "\n\n";
    equazione(1, -6, 5);
    ...
    equazione(1, 2, 1);
    cout << "\n\n";
    cout << (bisestile(2000) ? "E' bisestile" : "Non e' bisestile");
    cout << "\n\n";
    cout << (bisestile(2001) ? "E' bisestile" : "Non e' bisestile");
    cout << "\n\n";
    cout << (bisestile(1900) ? "E' bisestile" : "Non e' bisestile");
    cout << "\n\n";
    stampaTabelline(7);
    cout << "\n\n";
    stampaTabelline(5, 6);
